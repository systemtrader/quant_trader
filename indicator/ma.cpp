...
MA::MA(int period, int shift, ENUM_MA_METHOD ma_method, ENUM_APPLIED_PRICE applied_price, QObject *parent) :
    QObject(parent),
    MQL5IndicatorOnSingleDataBuffer(1, applied_price),
    InpMAPeriod(period),
    InpMAShift(shift),
    InpMAMethod(ma_method),
    ExtLineBuffer()
{
    //
}
