...
ParabolicSAR::ParabolicSAR(double step, double maximum, QObject *parent) :
    QObject(parent),
    MQL5Indicator(3),
    InpSARStep(step),
    InpSARMaximum(maximum),
    ExtSARBuffer(),
    ExtEPBuffer(),
    ExtAFBuffer()
{
...
//+------------------------------------------------------------------+
double ParabolicSAR::GetHigh(int nPosition,int nStartPeriod,const Mql5DynamicArray<double> &HiData)
  {
//--- calculate
...
//+------------------------------------------------------------------+
double ParabolicSAR::GetLow(int nPosition,int nStartPeriod,const Mql5DynamicArray<double> &LoData)
  {
//--- calculate
